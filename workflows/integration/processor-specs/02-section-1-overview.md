...
```
# Integration Test Plan: [TICKET-ID]
...
|----------|---|---|
| UI/UX | User interface and interaction tests | 3 |
| Business Logic | Core functionality and business rules | 4 |
| Data Persistence | Database and storage tests | 2 |
| API Integration | External service integration tests | 3 |
| Error Handling | Exception and error scenario tests | 2 |
| **TOTAL** | | **14** |
...
- Image evidence:
	- [filename + extracted observation + relevance]
- Spreadsheet evidence:
	- [filename + sheet + row/column + requirement or test data rule]
