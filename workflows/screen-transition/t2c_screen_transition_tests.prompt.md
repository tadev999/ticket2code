...
- **Screen Transition Test Stages** → `ticket2code/screen-transition-tests/agent-specs/01-stages.md`
- **Test Case Templates** → `ticket2code/screen-transition-tests/agent-specs/02-test-templates.md`
- **AC Mapping Rules** → `ticket2code/screen-transition-tests/agent-specs/03-ac-mapping.md`
- **Report Schema** → `ticket2code/screen-transition-tests/processor-specs/`
