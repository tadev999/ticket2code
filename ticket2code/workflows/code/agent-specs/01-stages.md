...
- Record selection as `Selected output language` and reuse it for all interactions and report content.
...
- Adjust analysis -> revise and re-present; do not proceed
- Add files -> revise and re-present; do not proceed
- Cancel -> stop
...
- For VSCode use vscode_askQuestions.
- If Yes: run tests/build and report result.
- If No: record deferred by DEV.
